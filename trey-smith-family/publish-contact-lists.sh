...
export RASPUTIN_KEY=1f4bcc5748c390f5f89f018b80af00af7ec98ff2bead7f0f69520ab044e6bd5f
...
export DINGLEBERRY_KEY=279bff3374596b0d34ef922a59780e9d0d2a80e83217037a9516f955cfb5ac7c
...
~/github.com/0xtrr/nostr-tool/target/release/nostr-tool -r wss://relay.rip --private-key $RASPUTIN_KEY publish-contact-list-csv -f trey-smith-family/contact-list.csv
...
~/github.com/0xtrr/nostr-tool/target/release/nostr-tool -r wss://relay.rip --private-key $DINGLEBERRY_KEY publish-contact-list-csv -f trey-smith-family/contact-list.csv
